...
**Windows 11** (System), **Visual Studio 2022** (C# - **.NET Framework 4.8 & .NET 6**), **Hugo** (Markdown), **Thonny** (Python), **JetBrains PyCharm** (Python), **Sublime Text** (for all), **Notepad++** (for all), **Mark Text** (Markdown), **ASM Visual** (Assembler)
