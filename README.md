...
I can't believe it... I almost don't program myself anymore, many projects were abandoned due to my great laziness and because of vibcoding, while at work AI seriously simplifies many aspects for me. But still... I think I'm losing a part of myself so much that I've been writing programs myself with great pleasure all these years... It's a pity, and it looks like I'm finally leaving GitHub as a platform for completely MY OWN projects, now there will most likely be various experimental projects here. And what's the point of even them? Now the world is full of false programmers who don't even delete programming languages, the main thing is to pay a subscription and you'll do even better than a team of developers or programmers who are really passionate about their work, just stupidly because of the best AI model... I'm honestly disappointed, even though I'm addicted to vibecoding myself, it's addictive like a drug or a slot machine.. What will happen next? Who the hell knows. It is necessary to adapt and change your views, plans and hobbies. Perhaps I will return to creative projects in the form of attempts to create games. I also think I should learn a programming language of some kind, continue to study and use the same GO, I can't keep up with Rust, and I don't need to, it makes sense... I've never liked Python, only when I needed to use it. As soon as the MacBook appears, there may also be motivation, but it's hard to say, maybe I'll learn the language from Apple, what's his name? Swift Like him. In short, I need to come back somehow and not be discouraged, because this is just progress, even if not what I would have wanted initially.. A lot of people talked about electricity, too, but now where is it? Everywhere! (there are no tribal units on Earth, but even they also have something to communicate with, the same Starlink)
